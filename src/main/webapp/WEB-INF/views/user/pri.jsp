...
<div class="background">
    <div style="min-height: 350px;">
        <c:if test="${priTopics.size()==0}">
            <h1 align="center" style="color: #6699CC">暂无帖子</h1>
        </c:if>
        <c:forEach items="${priTopics}" var="topic">
                    ...
                    <td style="width:750px;height: 30px">
                        <div
                            ...
                            <a
                                ...
                                href="/617/12139<c:out
								value="${topic.id}" />_<c:out value="${sessionScope.userInfo.id}" />.617museum"
        ...
        <div class="pageNav" align="right">
            ...
            <c:if test="${pageBean.totalPages == 2}">
                <c:if test="${pageBean.currentPage==1}">
                    ...
                    <button disabled="disabled">1</button>
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_2.617museum"><button>2</button>
                    </a>
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_<c:out value="${pageBean.currentPage+1}"/>.617museum"><button
                ...
                <c:if test="${pageBean.currentPage==2}">
                    ...
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_1.617museum"><button>1</button>
                    </a>
            ...
            <c:if test="${pageBean.totalPages == 3}">
                <c:if test="${pageBean.currentPage==1}">
                    ...
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_3.617museum"><button>3</button>
                    </a>
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_<c:out value="${pageBean.currentPage+1}"/>.617museum"><button
                            style="width: 80px;">下一页</button> </a>
            ...
            <c:if test="${pageBean.totalPages > 3}">
                <c:if test="${pagaBean.currentPage==1}">
                    ...
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_<c:out value="${pageBean.totalPages}" />.617museum"><button>
                ...
                <c:if test="${pageBean.currentPage==pageBean.totalPages}">
                    ...
                    <a><button disabled="disabled">...</button> </a>
                    <a
                            href="/617/12138<c:out value="${sessionScope.user.id}" />_<c:out value="${pageBean.totalPages-1}" />.617museum"><button>
        ...
        <script type="text/javascript">
            function goPage() {
                ...
                if (selectedPage != 0 && selectedPage != currentPage) {
                    document.goPageForm.action = "/617/12138<c:out value="${sessionScope.userInfo.id}" />_"
