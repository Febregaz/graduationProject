				...
				<tr>
					<td style="width:750px;height: 30px">
						<div
							...
							<font style="font-size: 12px;color: #817E7E;">&nbsp;用户&nbsp;</font><a href="/617/Morgana<c:out
										value="${tnew.newsCommentUser.id}" />.617museum" target="_top" style="font-size: 15px;"><c:out
									value="${tnew.newsCommentUser.nickname}" />
							</a><font style="font-size: 12px;color: #817E7E;">&nbsp;评论了您的帖子&nbsp;</font><a
								href="/617/Ahri<c:out value="${tnew.newsTopic.id}"></c:out>_1.617museum"
