		...
		<c:forEach items="${hotTopicsList}" var="hot">
			...
			<tr>
				...
				<td align="right" width="80px;"><div
					...
					<a class="topicTitle"
					   href="/617/Morgana<c:out value="${hot.topicsUser.id}"></c:out>.617museum"
