	...
	<div class="tbody">
		<div class="smallNav" align="left">
			...
			<div style="float: left;line-height:24px;">
				&nbsp;&gt;&nbsp;<a href="NC-JSP/home/index.jsp">论坛</a>&nbsp;&gt;&nbsp;精品帖子
			</div>
		</div>
		<div>
			<div class="editMenu">
				<input type="button" value="发帖" class="butt" style="width: 80px;"
					   onclick="checkNewTop()" /> <input type="button" value="刷新"
														 onclick="window.location.href = 'topics/getAllNiceTopics?nowPage=1'"
			...
			<div class="pageNav" align="right">
				...
				<c:if test="${pageBean.totalPages == 2}">
					<c:if test="${pageBean.currentPage==1}">
						...
						<button disabled="disabled">1</button>
						<a
								href="topics/getAllNiceTopics?nowPage=2"><button>2</button>
						</a>
						<a
								href="topics/getAllNiceTopics?nowPage=<c:out value="${pageBean.currentPage+1}"/>"><button
					...
					<c:if test="${pageBean.currentPage==2}">
						...
						<a
								href="topics/getAllNiceTopics?nowPage=1"><button>1</button>
						</a>
				...
				<c:if test="${pageBean.totalPages == 3}">
					<c:if test="${pageBean.currentPage==1}">
						...
						<a
								href="topics/getAllNiceTopics?nowPage=3"><button>3</button>
						</a>
						<a
								href="topics/getAllNiceTopics?nowPage=<c:out value="${pageBean.currentPage+1}"/>"><button
								style="width: 80px;">下一页</button> </a>
				...
				<c:if test="${pageBean.totalPages > 3}">
					<c:if test="${pagaBean.currentPage==1}">
						...
						<a
								href="topics/getAllNiceTopics?nowPage=<c:out value="${pageBean.totalPages}" />"><button>
					...
					<c:if test="${pageBean.currentPage==pageBean.totalPages}">
						...
						<a><button disabled="disabled">...</button> </a>
						<a
								href="topics/getAllNiceTopics?nowPage=<c:out value="${pageBean.totalPages-1}" />"><button>
			...
			<script type="text/javascript">
                function goPage() {
                    ...
                    if (selectedPage != 0 && selectedPage != currentPage) {
                        document.goPageForm.action = "topics/getAllNiceTopics?nowPage="
                            + selectedPage;
                        goPageForm.submit();
                    }
