			...
			<div>
				<div class="editMenu">
					<input type="button" value="发帖" class="butt" style="width: 80px;"
						...
						onclick="window.location.href = 'topics/getAllHotTopics?nowPage=1'"
				...
				<div class="pageNav" align="right">
					...
					<c:if test="${pageBean.totalPages == 2}">
						<c:if test="${pageBean.currentPage==1}">
							...
							<button disabled="disabled">1</button>
							<a
									href="topics/getAllHotTopics?nowPage=2"><button>2</button>
							</a>
							<a
									href="topics/getAllHotTopics?nowPage=<c:out value="${pageBean.currentPage+1}"/>"><button
						...
						<c:if test="${pageBean.currentPage==2}">
							...
							<a
									href="topics/getAllHotTopics?nowPage=1"><button>1</button>
							</a>
					...
					<c:if test="${pageBean.totalPages == 3}">
						<c:if test="${pageBean.currentPage==1}">
							...
							<a
									href="topics/getAllHotTopics?nowPage=3"><button>3</button>
							</a>
							<a
									href="topics/getAllHotTopics?nowPage=<c:out value="${pageBean.currentPage+1}"/>"><button
									style="width: 80px;">下一页</button> </a>
					...
					<c:if test="${pageBean.totalPages > 3}">
						<c:if test="${pagaBean.currentPage==1}">
							...
							<a
									href="topics/getAllHotTopics?nowPage=<c:out value="${pageBean.totalPages}" />"><button>
						...
						<c:if test="${pageBean.currentPage==pageBean.totalPages}">
							...
							<a><button disabled="disabled">...</button> </a>
							<a
									href="topics/getAllHotTopics?nowPage=<c:out value="${pageBean.totalPages-1}" />"><button>
				...
				<script type="text/javascript">
					function goPage() {
						...
						if (selectedPage != 0 && selectedPage != currentPage) {
							document.goPageForm.action = "topics/getAllHotTopics?nowPage="
									+ selectedPage;
							goPageForm.submit();
						}
