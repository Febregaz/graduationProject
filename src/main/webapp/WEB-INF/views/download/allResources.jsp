...
<head>
    ...
    <script type="text/javascript">
        ...
        function checkDeleteOrNot(ss) {
            if(ss==1){
                alert("不好意思，该资源已被冻结，无法下载")
                return false;
            }
        }
    </script>
    ...
    <div class="tbody">
        <div class="smallNav" align="left">
            ...
            <div style="float: left;line-height:24px;">
                &nbsp;&gt;&nbsp;<a href="NC-JSP/home/index.jsp">论坛</a>&nbsp;&gt;&nbsp;所有帖子
            </div>
        </div>
        <div>
            <div class="editMenu">
            ...
            <div class="pageGo" align="right">
                <form action="topic_getAllTopic.action" method="post" name="goPageForm">
                    <input type="text" id="currentPage" value="<c:out value="${pageBean.currentPage}" />"
                           style="display: none">
        ...
        <div class="titleStyle" align="left">
            <table border="0" style="margin: 0;		font-size: 12px;">
                <tr style="height: 30px;line-height: 30px;">
                    ...
                    <td style="width:140px" align="center">发布者</td>
                    <td style="width:40px" align="center">积分</td>
                    <td style="width:40px" align="center">次数</td>
                ...
                <c:forEach items="${resourcesList}" var="resources">
                    <tr>
                        <td style="width:160px;" align="left">&nbsp;<a
                                ...
                                value="${resources.resourcesType.typesCategory.namee}" /> </a>-<a
                                target="_top" style="font-size: 14px;"><c:out
                                value="${resources.resourcesType.name}" /> </a></td>
                        <td align="left"><div
                            ...
                            <font style="font-size: 13px;color: #4C9ED9"><c:if
                                    test="${resources.niceResources==1}">[<font color="red">精品</font>]</c:if> <c:if test="${resources.niceResources==0}"></c:if>[<c:if
                                    test="${resources.resourceStatus==0}">资源激活</c:if> <c:if test="${resources.resourceStatus==1}">资源冻结</c:if>]</font><a
                                onclick="return checkDeleteOrNot(<c:out value="${resources.resourceStatus}" />)"
                                href="/resources/downloadFile?fileName=<c:out value="${resources.resourcesURL}"></c:out>"
                                target="_top" class="topicTitle" style="color:red"><c:out
                                value="${resources.resourcesName}" /> </a>
                        </div>
                        </td>

                        <td align="center" width="140px;"><a class="topicTitle"
                                                             href="/users/getUserById?userId=<c:out
										value="${resources.resourcesUser.id}" />"
                                                             target="_top" style="font-size: 14px;"><c:out
                                value="${resources.resourcesUser.nickname}" /> </a>
                        </td>
                        <td align="center" width="40px" style="font-size: 13px;"><c:out
                                value="${resources.resourcesIntegral}" />
                        </td>
                        <td align="center" width="40px" style="font-size: 13px;"><c:out
                                value="${resources.downloadTimes}" />
                        </td>
                        <td style="font-size: 12px;" width="110px;" align="right"><fmt:formatDate value="${resources.publishTime }" type="date"/>
                        </td>
                    </tr>
                </c:forEach>
            </table>
