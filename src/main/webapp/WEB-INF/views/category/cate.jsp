...
<title><c:out value="${category.namee}" /></title>
...
.typeStyle:hover {
	background-image: url("../../statics/images/type_bg.png");
	color: red;
}
</style>
						...
						<div class="typeStyle" align="left"
							...
							<div style="width: 130px;height: 60px;float: left;">
								...
								<div
									...
									共
									<c:out value="${type.countTopics}" />
									主题/
									<c:out value="${type.countComments}" />
									回复
								</div>
							</div>
						</div> </a>
			...
			<div>
				<table align="left" class="listTopicStyle">
					<c:forEach items="${listTopic}" var="topic">
						<tr>
							<td style="width:100px;" align="left">&nbsp;&nbsp;<c:out
							...
							<td style="font-size: 12px;" width="100px;" align="right"><fmt:formatDate value="${topic.topicTime}" type="date"/></td>
						</tr>
					</c:forEach>
				</table>
			</div>
