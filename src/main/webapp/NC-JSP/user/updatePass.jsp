...
function checkopass() {
	...
	if (userPass != userDOPass) {
		prts.innerHTML = "&nbsp;<img src='images/wrong.gif'></img>&nbsp;旧密码输入错误!";
		prts.style.color = "red";
		prts.style.backgroundColor = '#F8F8F8';
		prts.style.border = '1px solid red';
		return false;
...
<div id="home" align="left">
	<form action="users/updateUserPass" method="post"
		...
		<table style="padding-top: 80px;margin-left: 80px">
			<tr>
				...
				<td><input id="oldPass" type="password"
					...
					class="inputText"
					value="<c:out value="${sessionScope.userInfo.password}" />" /> <input
					id="defaultOldPass" type="password" style="display: none;"
					value="<c:out value="${sessionScope.userInfo.password}" />" />
				</td>
				<td id="oldPassts"
