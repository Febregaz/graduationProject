		...
		<div class="tBody" style="float: left;">
			<div class="topBody" align="left">
				...
				<div style="float: left;line-height:24px;">
					&nbsp;&gt;&nbsp;<a href="NC-JSP/home/index.jsp">论坛</a>&nbsp;&gt;&nbsp;关于论坛
				</div>
			</div>
			<div
				...
				<p style="line-height: 2em;">
					<span style=";font-size:14px;font-family:'宋体'">&nbsp;&nbsp;&nbsp;
							 sevenZero论坛由<a href="http://www.dreamstation.cn" style="color: red" target="_blank">70</a>团队（英文名<a href="http://www.dreamstation.cn" style="color: red" target="_blank">sevenZero</a>，缩写SZ）创立于2018年3月，旨在为广大IT和软件编程从业者及爱好者提供知识传播、经验交流和发展兴趣社交的服务平台。在开放、包容和高互动性的氛围带动下，结合严谨的隐私和版权管理体制，本论坛吸引了大量具有专业知识或相关兴趣的用户群，并拥有高质量的精品原创内容，形成了独具特色的论坛文化，拥有一定的舆论影响力。</span>
				</p>
				<p style="line-height: 2em;">
					<span style=";font-size:14px;font-family:'宋体'">&nbsp;&nbsp;&nbsp;
