				...
				<table>
					...
					<tr>
						...
						<td><input type="text" class="inputText"
							value="<c:out value="${sessionScope.userInfo.nickname}" />"
					...
					<tr>
						...
						<td><input type="text" name="userEmail" class="inputText"
							id="uEmail" value="<c:out value="${sessionScope.userInfo.email}" />"
							onfocus="warnEmail()" onblur="return checkemail();" /><input
							id="defaultEmail"
							value="<c:out value="${sessionScope.userInfo.email}" />"
							style="display: none;" />
						</td>
						<td id="emailts"
					...
					<tr>
						...
						<td><input type="text" class="inputText" name="userProfe"
							value="<c:out value="${sessionScope.userInfo.profession}" />">
						</td>
					</tr>
					...
					<tr>
						...
						<td><input type="text" class="inputText" name="userFrom"
							value="<c:out value="${sessionScope.userInfo.comefrom}" />"></td>
					</tr>
				</table>
				个人简介<br />
				<textarea style="width: 450px;height: 100px;resize: none;"
					value="${sessionScope.userInfo.introduction}" name="userIntro">${sessionScope.userInfo.introduction}
				</textarea>
	...
	<div align="center"
		...
		<form action="users/uploadUserPic" enctype="multipart/form-data"
			...
			<input type="text" name="userUsername"
				value="<c:out value="${sessionScope.userInfo.username}" />"
				style="display: none;" />
			<p>
